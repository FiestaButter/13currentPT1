...
<head>
  ...
  <meta name="description" content="contact us disc">
...
<body>
  <section class="menu menu2 cid-sb4KS6FvqD" once="menu" id="menu2-2y">
...
<section class="features11 cid-sb9ctnQe9k" id="features12-33">
        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg offset-lg-1">
                <div class="card-wrapper">
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style mb-4 display-2"><strong>Don't be shy!</strong></h4>
                        <p class="mbr-text mbr-fonts-style mb-4 display-7">We understand that your project is special and deserves the time of day, let us know what on your mind.&nbsp;&nbsp;</p>
            ...
            <div class="col-12 col-lg-6 md-pb">
                <div class="image-wrapper">
                    <img src="assets/images/bg-2-1076x527.png" alt="Pokemon Unity">
                </div>
            </div>
        </div>
    </div>
...
<section class="form5 cid-sb9czpd4jp" id="form5-34">
...
<section class="features13 cid-sb9cr2XFq4" id="features14-32">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="mbr-section-title align-center mb-4 mbr-fonts-style display-2"><strong>Buying With Us</strong></h3>
            </div>
            <div class="card col-12 col-md-4 col-lg-2 p-3">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <span class="mbr-iconfont mbri-like" style="color: rgb(255, 188, 74); fill: rgb(255, 188, 74);"></span>
                        <h4 class="card-title align-center mbr-black mbr-fonts-style display-7"><strong>Tailored&nbsp;Fit</strong></h4>
                    </div>
                </div>
            </div>
            <div class="card p-3 col-12 col-md-4 col-lg-2">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <span class="mbr-iconfont mbri-cash" style="color: rgb(255, 188, 74); fill: rgb(255, 188, 74);"></span>
                        <h4 class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <strong>Don't Break the Bank</strong></h4>
                    </div>
                </div>
            </div>
            <div class="card p-3 col-12 col-md-4 col-lg-2">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <span class="mbr-iconfont mbri-globe" style="color: rgb(255, 188, 74); fill: rgb(255, 188, 74);"></span>
                        <h4 class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <strong>Shipping's on Us</strong></h4>
                    </div>
                </div>
            </div>
            <div class="card p-3 col-12 col-md-4 col-lg-2">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <span class="mbr-iconfont mobi-mbri-hearth mobi-mbri" style="color: rgb(255, 188, 74); fill: rgb(255, 188, 74);"></span>
                        <h4 class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <strong>Here for You</strong></h4>
                    </div>
                </div>
            </div>
            <div class="card p-3 col-12 col-md-4 col-lg-2">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <span class="mbr-iconfont mbri-cart-full" style="color: rgb(255, 188, 74); fill: rgb(255, 188, 74);"></span>
                        <h4 class="card-title align-center mbr-black mbr-fonts-style display-7"><strong>Buy More for Less</strong></h4>
                    </div>
                </div>
            </div>
            <div class="card p-3 col-12 col-md-4 col-lg-2">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <span class="mbr-iconfont mbri-gift" style="color: rgb(255, 188, 74); fill: rgb(255, 188, 74);"></span>
                        <h4 class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <strong>+ Perfect for a Friend</strong></h4>
                    </div>
                </div>
            </div>
        </div>
...
<section class="content15 cid-sdIzVvdMX1" id="content15-97">
...
<section class="footer4 cid-sb4VKnYYWJ" once="footers" id="footer4-2z">
...
</section><section style=""><a href="https://mobirise.site" style=""></a></section>
...
<script src="assets/mobirise/js/bootstrap-contact.js" type="text/javascript"></script>
